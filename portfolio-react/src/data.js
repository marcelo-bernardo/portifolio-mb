...
export const projects = [
  ...
  },
  {
    id: '04',
    title: 'Serie Journal',
    description: 'Crud para registro e acompanhamento de séries assistidas, com interface responsiva.',
    stack: ['API REST', 'React', 'Node.js', 'Express', 'MySQL'],
    url: 'https://github.com/marcelo-bernardo/serie_journal',
  },
  {
    id: '05',
    title: 'Atend+',
    description: 'Sistema de gerenciamento de atendimentos, com cadastro de clientes e registro de ocorrências. Desenvolvimento ENACTUS AGEAD UFMS',
    stack: ['React Native', 'Css', 'Node.js'],
...
export const skillGroups = [
  {
    title: 'Linguagens',
    items: ['Python', 'C', 'C++', 'Java', 'JavaScript', 'HTML', 'CSS', 'SQL', 'PHP', 'Bash'],
  },
  {
    title: 'Ferramentas',
    items: ['Git & GitHub', 'MySQL', 'Linux', 'VS Code', 'WordPress', 'Docker', 'Postman', 'Figma', 'Jira', 'Trello'],
  },
  {
    title: 'Frameworks',
    items: ['Bootstrap', 'Pico CSS', 'Pandas', 'Laravel', 'React', 'Node.js', 'Express', 'React Native'],
  },
];
